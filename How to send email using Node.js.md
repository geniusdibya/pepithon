...
2. Double click on the msi file to start the installer, then click 'Run'. Like any other installation on windows, you have just to click "Next" button several times to complete the installation :)

![accept terms](https://i.imgur.com/RfVrQWC.png)

3. Read and accept the terms in the licence agreement
...
node mailer.js
```
8. Email sent to the recipient's email address. 
